// Alternative ESLint config using XO rules with more lenient configuration
// This file shows the full XO integration. Use eslint.config.js for the actual configuration.
...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      // Rules disabled in xo.config.ts
      ...
      // XO unicorn rules that are disabled
