...
const companyNames = [
  'ABC Corporation', 'XYZ Industries', 'Global Tech Solutions', 'Prime Manufacturing',
  'Elite Services', 'Innovative Systems', 'Quality Products Ltd', 'Dynamic Enterprises',
  'Modern Solutions', 'Advanced Technologies', 'Future Vision Corp', 'Smart Industries',
];
