                    ...
                    <Group gap="xs" align="flex-start">
                      ...
                      <div>
                        ...
                        <Text size="sm" c="dimmed">
                          ...
                          {purchaseOrder.shippingAddress.postalCode && ` ${purchaseOrder.shippingAddress.postalCode}`}
                        </Text>
                        <Text size="sm" c="dimmed">{purchaseOrder.shippingAddress.country}</Text>
                      </div>
                    </Group>
                  </div>
                </Grid.Col>
                    ...
                    <Group gap="xs" align="flex-start">
                      ...
                      <div>
                        ...
                        <Text size="sm" c="dimmed">
                          ...
                          {purchaseOrder.billingAddress.state && `, ${purchaseOrder.billingAddress.state}`}
                          {purchaseOrder.billingAddress.postalCode && ` ${purchaseOrder.billingAddress.postalCode}`}
                        </Text>
                        <Text size="sm" c="dimmed">{purchaseOrder.billingAddress.country}</Text>
                      </div>
                    </Group>
                  </div>
                </Grid.Col>
